...
public class SuiteRoomFormView {

	/*
	 * The method loadWindow loads the SuiteRoomFormView. suite_form.fxml
	 * contains RentRoomView Layout
	 */
	public void loadWindow() {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(getClass().getResource("/view/suite_form.fxml"));
			Parent root = loader.load();
			Scene scene = new Scene(root); // temporary file

			Stage dialogBox = new Stage();
			dialogBox.setTitle("Add a Suite Room"); // Set the stage title
