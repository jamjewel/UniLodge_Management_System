...
public class DateTime {
	...
	public static DateTime parseFormattedDate(String formattedDate) throws ParseException {
		...
		DateTime dateTime = new DateTime(c.get(Calendar.DAY_OF_MONTH), c.get(Calendar.MONTH) + 1, c.get(Calendar.YEAR));
		return dateTime;
